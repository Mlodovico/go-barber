...
describe('Create Appointment', function () {
    beforeEach(function () {
        ...
        createAppoitment = new CreateAppointmentService_1.default(fakeAppointmentsRepository, fakeNotificationsRepository, fakeCacheProvider);
    });
    it('should be able to create an appointment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createAppoitment.execute({
                ...
                case 1:
                    appointment = _a.sent();
                    return [4 /*yield*/, expect(appointment).toHaveProperty('id')];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expect(appointment.provider_id).toBe('2354346456')];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appointmentDate = new Date(2020, 7, 20, 23);
                    return [4 /*yield*/, expect(createAppoitment.execute({
    ...
    it('should not be able to create an appointment before 8 AM', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment after 17 PM', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
