...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentInSameDay, appointment, dateFormatted;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentDate = date_fns_1.startOfHour(date);
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default("You can't create an appointment in a past date ");
                        }
                        ...
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default("You can only create an appointmente between 8AM and 17PM");
                        }
                        return [4 /*yield*/, this.appointmentsRepository.findByDate(appointmentDate, provider_id)];
                    case 1:
                        findAppointmentInSameDay = _b.sent();
                        if (findAppointmentInSameDay) {
                            throw new AppError_1.default('This appointment is already booked', 401);
                        }
                    ...
                    case 2:
                        appointment = _b.sent();
                        dateFormatted = date_fns_1.format(appointmentDate, "dd/MM/yyyy 'às' HH:mm");
