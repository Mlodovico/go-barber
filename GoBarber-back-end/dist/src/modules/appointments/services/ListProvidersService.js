            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.usersRepository.findAllProvider({
                                except_user_id: user_id,
                            })];
                    case 2:
                        users = _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this.cacheProvider.save("providers-list:" + user_id, class_transformer_1.classToClass(users))];
                    case 4:
                        _b.sent();
