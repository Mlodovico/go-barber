...
describe('UpdateProfile', function () {
    ...
    it('should be able to update the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    updatedUser = _a.sent();
                    return [4 /*yield*/, expect(updatedUser.name).toBe('Jane Doe')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, expect(updatedUser.email).toBe('jdoe@hotmail.com')];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should be able to update password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, updatedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRepository.create({
    ...
    it('should not be able to update password without old password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRepository.create({
