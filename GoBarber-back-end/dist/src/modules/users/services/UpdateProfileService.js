...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, userWithUpdatedEmail, checkOldPassword, _b, userUpdated;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (!checkOldPassword) {
                            throw new AppError_1.default('Wrond old password');
                        }
                        _b = user;
                    ...
                    case 4:
                        _b.password = _c.sent();
                        _c.label = 5;
                    case 5: return [4 /*yield*/, this.usersRepository.save(user)];
                    case 6:
                        userUpdated = _c.sent();
