...
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmail = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recover password using email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
