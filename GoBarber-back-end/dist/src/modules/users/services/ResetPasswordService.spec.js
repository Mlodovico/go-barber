...
describe('ResetPassword', function () {
    beforeEach(function () {
        ...
        resetPassword = new ResetPasswordService_1.default(fakeUserRepository, fakeUserTokensRepository, fakeHashProvider);
    });
    it('should be able reset the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, fakeUserRepository.findById(user.id)];
                case 4:
                    updatedUser = _a.sent();
                    expect(generateHash).toHaveBeenCalledWith('1234567');
                    expect(updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.password).toBe('1234567');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('should not be able reset password if passed more the 2 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserRepository.create({
