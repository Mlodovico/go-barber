...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.findAllProvider = function (_a) {
    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        newUser = this.ormRepository.create({ name: name, email: email, password: password });
                        return [4 /*yield*/, this.ormRepository.save(newUser)];
                    case 1:
                        _b.sent();
    ...
    UsersRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.ormRepository.create(user)];
            });
        });
    };
