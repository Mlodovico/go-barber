...
var ForgotPasswordController = /** @class */ (function () {
    ...
    ForgotPasswordController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var email, sendForgotPasswordEmail;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = req.body.email;
                        sendForgotPasswordEmail = tsyringe_1.container.resolve(SendForgotPasswordEmailService_1.default);
