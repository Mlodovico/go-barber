...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.show = function (req, resp) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, resp.status(200).json(class_transformer_1.classToClass(user))];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = req.user.id;
                        _a = req.body, name = _a.name, email = _a.email, old_password = _a.old_password, password = _a.password;
                    ...
                    case 1:
                        user = _b.sent();
                        return [2 /*return*/, res.status(200).json(class_transformer_1.classToClass(user))];
                }
            });
        });
    };
